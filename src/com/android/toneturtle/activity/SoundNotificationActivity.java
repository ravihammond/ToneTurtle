...
public class SoundNotificationActivity extends SoundActivity{
	@Override
	...
	protected void setData() {
		...
		playlist = app.getNotificationPlaylist(position);
	...
	protected void resetCurrentPlaylist() {
		if(position == app.getCurrentNotificationPlaylist().Int){
			app.removeCurrentNotifications();
	...
	protected void setOwnListeners() {
		mode_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View view, int spinner_position, long id) {
            	app.setNotificationMode(position, spinner_position);
            }
